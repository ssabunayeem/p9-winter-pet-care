                ...
                <div className="card bg-[#dae3ee] w-[350px] md:w-[650px] md:p-8 shrink-0 shadow-2xl rounded-4xl">
                    <div className="card-body">
                        <fieldset className="fieldset">
                            ...
                            <input type="text" className="input w-full py-6 text-lg rounded-full" placeholder="Your Name" />
                            <label className="label text-lg">PhotoUrl</label>
                            <input type="text" className="input w-full py-6 text-lg rounded-full" placeholder="PhotoUrl" />
